public class SinglyLinkedList {
    ...
    // Implement a find(int) method that will return the first node with the value
    // in the parameter
    ...
    // Implement a removeAt(int) method that will remove the node after n nodes,
    // where n is the parameter. For example, if n is 0, remove the first node. If n
    // is 1, remove the second node. Similar to Arrays.
        ...
        if (this.head == null) {
            ...
            while (counter != removeAtNodeNum) {
                ...
                if (removeAtNodeNum == 1) {
                    ...
                    runner.next = runner.next.next;
                    System.out.println(
                            "The node #" + removeAtNodeNum + "with the value " + removeVal + " has been removed");
                    return;
                }
            }
        }
